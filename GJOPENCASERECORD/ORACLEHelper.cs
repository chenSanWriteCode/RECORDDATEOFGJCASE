...
namespace DF.BusEntry.DAL
{
    public class ORACLEHelper
    {

        //数据库连接字符串(web.config来配置)，可以动态更改connectionString支持多数据库.  
        //public static string connectionString = ConfigurationManager.ConnectionStrings["OleOracleConnect"].ConnectionString;
        public static string connectionString = ConfigurationManager.AppSettings.GetValues("OleOracleConnect")[0];
        public ORACLEHelper()
        {
        }
        #region 公用方法
